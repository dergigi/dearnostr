...
export default function PostForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full relative">
      ...
      {displayName && (
        <div className="mb-3 text-left pl-6">
          <span 
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 px-6 py-3 bg-transparent hover:bg-amber-100/50 disabled:opacity-40 disabled:cursor-not-allowed text-amber-800 disabled:text-amber-400 font-semibold transition-all duration-200 border-t border-dotted border-amber-800 disabled:border-amber-400 pt-4 mt-2"
      >
        {loading ? (
          <>
